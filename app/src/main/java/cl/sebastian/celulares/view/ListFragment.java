...
public class ListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = view.findViewById(R.id.productRecycler); //de mi fragment y el id de mi recyclerview
        viewModel = new ViewModelProvider(this).get(TelefonosViewModel.class);
        viewModel.getListaProducto().observe(getViewLifecycleOwner(), new Observer<List<Producto>>() {
            @Override
        ...
        adapter.getSelected().observe(getViewLifecycleOwner(), new Observer<Producto>() {
            ...
            public void onChanged(Producto producto) {
                Log.d(TAG, "onChanged: "+producto.toString());
